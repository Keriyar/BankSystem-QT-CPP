...
public:
    ...
    void WriteFile();
    //账户操作
    void AddAccount(string, string, string, string, int, double, string,string);
    ...
    string GetIdentity(string);

    //get information by the index in vAccount
...
private:
   ...
   //This structure records the information of every accounts.
    struct accountInfo
    {
        ...
        string identity;        /// identity of the account
    };
